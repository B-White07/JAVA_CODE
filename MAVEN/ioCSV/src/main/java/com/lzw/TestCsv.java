...
public class TestCsv {
    public static void main(String[] args) throws IOException {
        ...
        String inString = "";
        String tmpString = "";
        File inFile = new File("D:\\DevelopmentTools\\JetBrains\\IdeaProjects\\MAVEN\\Test\\time.csv"); // 读取的CSV文件
        File outFile = new File("D:\\DevelopmentTools\\JetBrains\\IdeaProjects\\MAVEN\\Test\\time.csv");//输出的CSV文
        try {
