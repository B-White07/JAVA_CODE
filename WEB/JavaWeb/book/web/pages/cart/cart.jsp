		...
		$(function () {
			...
			$(".updateCount").change(function () {
				...
				if(confirm("你确定要将 [ " + name + "] 的数量修改为 " + count + " 吗？" )){
					<%--if( count > ${sessionScope.book.count}){--%>
					<%--	alert("${requestScope.book.stock}");--%>
					<%--	count = ${sessionScope.book.count};--%>
					<%--}--%>
					//	发起请求，给服务器保存修改
	...
	<div id="main">
		<table>
			...
			<c:if test="${empty sessionScope.cart.items}">
				<tr>
					<td colspan="5"><a href="index.jsp">前购物车为空,点击选购！！</a></td>
				</tr>
			</c:if>
<%--			购物车非空的情况--%>
